      ...
      <div className="w-11/12 mx-auto mt-10 grid  md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="card bg-base-100 shadow-lg">
          <div className="card-body">
            ...
            <div className="mt-6">
              <button className="btn bg-linear-65 from-[#4F39F6] to-[#9514FA] btn-block border-none rounded-full text-white mr-4">
                Get Started Free
              </button>
            </div>
          </div>
        ...
        <div className="card bg-linear-65 from-[#4F39F6] to-[#9514FA] shadow-lg">
          <div className="card-body">
            ...
            <div className="mt-6">
              <button className="btn bg-white text-[#9514FA] btn-block border-none rounded-full mr-4">
                Start Pro Trial
              </button>
            </div>
          </div>
